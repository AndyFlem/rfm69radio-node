...
A [node-red](https://nodered.org/) node for sending and receiving through RFM69 radios on the Raspberry Pi.

Wraps the [rfm69radio](https://github.com/AndyFlem/rfm69radio) code.

## Hardware
This version tested on a pair of [Adafruit RFM69HCW Radios](https://learn.adafruit.com/adafruit-rfm69hcw-and-rfm96-rfm95-rfm98-lora-packet-padio-breakouts/overview) with this node-red running on a [Raspberry Pi 3 Model B](https://www.raspberrypi.org/products/raspberry-pi-3-model-b/). 
